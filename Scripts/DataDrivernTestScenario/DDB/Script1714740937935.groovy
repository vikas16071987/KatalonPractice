...
WebUI.click(findTestObject('Page_Amazon.com Mothers Day/a_Mothers Day Gifts'))

WebUI.mouseOver(findTestObject('Object Repository/Page_Amazon.com Mothers Day/a_Hello, Mansi  Account  Lists'))

WebUI.click(findTestObject('Object Repository/Page_Your Account/span_Sign Out'))
